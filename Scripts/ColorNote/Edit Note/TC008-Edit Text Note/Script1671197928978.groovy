...
Mobile.setText(findTestObject('ColorNote/Edit Note/Revert Edit/Edit Text Area'), 'Test Edit', 0)

Mobile.tap(findTestObject('Object Repository/ColorNote/Edit Note/Edit Text Note/Save Button'), 0)
