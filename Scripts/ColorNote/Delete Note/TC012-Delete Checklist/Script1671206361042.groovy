...
Mobile.tap(findTestObject('ColorNote/Delete Note/Delete Text Note/More Button'), 0)

Mobile.tap(findTestObject('ColorNote/Delete Note/Delete Text Note/Delete Button'), 0)

Mobile.tap(findTestObject('ColorNote/Delete Note/Delete Text Note/Button - OK'), 0)
